...
class Tomek20:
    ...
    def differentiate(self, V):
        ...
        INab = (((self.PNab*vffrt)*((self.Nai*(torch.exp(vfrt)))-(self.Nae)))/((torch.exp(vfrt))-(1.)))
        ...
        F1 = ((torch.exp((self.b*C)))-(1.))
        ICab = ((((self.PCab*4.)*vffrt)*(((gamma_cai*self.Cai_mM)*(torch.exp((2.*vfrt))))-((gamma_Cae*self.Cae))))/((torch.exp((2.*vfrt)))-(1.)))
        IClCa = (IClCa_junc+IClCa_sl)
        K1ss = (aK1/(aK1+bK1))
        PhiCaK_i = ((vffrt*(((gamma_Ki*self.Ki)*(torch.exp(vfrt)))-((gamma_Ke*self.Ke))))/((torch.exp(vfrt))-(1.)))
        PhiCaK_ss = ((vffrt*(((gamma_kss*self.kss)*(torch.exp(vfrt)))-((gamma_Ke*self.Ke))))/((torch.exp(vfrt))-(1.)))
        PhiCaL_i = (((4.*vffrt)*(((gamma_cai*self.Cai_mM)*(torch.exp((2.*vfrt))))-((gamma_Cae*self.Cae))))/((torch.exp((2.*vfrt)))-(1.)))
        PhiCaL_ss = (((4.*vffrt)*(((gamma_cass*self.cass)*(torch.exp((2.*vfrt))))-((gamma_Cae*self.Cae))))/((torch.exp((2.*vfrt)))-(1.)))
        PhiCaNa_i = ((vffrt*(((gamma_Nai*self.Nai)*(torch.exp(vfrt)))-((gamma_Nae*self.Nae))))/((torch.exp(vfrt))-(1.)))
        PhiCaNa_ss = ((vffrt*(((gamma_nass*self.nass)*(torch.exp(vfrt)))-((gamma_Nae*self.Nae))))/((torch.exp(vfrt))-(1.)))
        ...
        Tp_me1 = (self.a*(((torch.exp((self.b*Cme1)))-(1.))+(self.par_k*(Cme1-(self.CD)))))
        Tp_pe1 = (self.a*(((torch.exp((self.b*Cpe1)))-(1.))+(self.par_k*(Cpe1-(self.CD)))))
        ...
        Tp_2 = (self.a*(((torch.exp((self.b*C_2)))-(1.))+(self.par_k*(C_2-(self.CD)))))
        Tp_me2 = (self.a*(((torch.exp((self.b*Cme2)))-(1.))+(self.par_k*(Cme2-(self.CD)))))
        Tp_pe2 = (self.a*(((torch.exp((self.b*Cpe2)))-(1.))+(self.par_k*(Cpe2-(self.CD)))))
        ...
        Tp_3 = (self.a*(((torch.exp((self.b*C_3)))-(1.))+(self.par_k*(C_3-(self.CD)))))
        Tp_me3 = (self.a*(((torch.exp((self.b*Cme3)))-(1.))+(self.par_k*(Cme3-(self.CD)))))
        Tp_pe3 = (self.a*(((torch.exp((self.b*Cpe3)))-(1.))+(self.par_k*(Cpe3-(self.CD)))))
