...
class TWorld:
    ...
    def differentiate(self, V):
        ...
        PhiCaK_i = ((vffrt*(((gamma_ki*self.Ki)*(torch.exp(vfrt)))-((gamma_ko*self.Ke))))/((torch.expm1(vfrt))))
        PhiCaK_ss = ((vffrt*(((gamma_kss*self.Ki)*(torch.exp(vfrt)))-((gamma_ko*self.Ke))))/((torch.expm1(vfrt))))
        PhiCaL_i = (((4.*vffrt)*(((gamma_cai*self.Cai)*(torch.exp((2.*vfrt))))-((gamma_cao*self.Cae))))/((torch.expm1((2.*vfrt)))))
        PhiCaL_ss = (((4.*vffrt)*(((gamma_cass*self.casl)*(torch.exp((2.*vfrt))))-((gamma_cao*self.Cae))))/((torch.expm1((2.*vfrt)))))
        PhiCaNa_i = ((vffrt*(((gamma_nai*self.Nai)*(torch.exp(vfrt)))-((gamma_nao*self.Nae))))/((torch.expm1(vfrt))))
        PhiCaNa_ss = ((vffrt*(((gamma_nass*self.nasl)*(torch.exp(vfrt)))-((gamma_nao*self.Nae))))/((torch.expm1(vfrt))))
        ...
        set_jrel_icaldep_f1_tozero_in_diff_jrel_icaldep_f1 = ((1./(1.+((1.-((1./(1.+(torch.pow(((torch.abs((((((1.-(self.camk_f_ICaL))*(((((1.5768e-04))*(((4.*(((V*96485.)*96485.)/(8314.*310.)))*((((torch.pow(10.,(((-(1.82e6*(pow((74.*310.),-1.5))))*4.)*(((torch.sqrt(((0.5*(((self.nasl+self.Ki)+self.Cli)+(4.*self.casl)))/1000.)))/(1.+(torch.sqrt(((0.5*(((self.nasl+self.Ki)+self.Cli)+(4.*self.casl)))/1000.)))))-((0.3*((0.5*(((self.nasl+self.Ki)+self.Cli)+(4.*self.casl)))/1000.)))))))*self.casl)*(torch.exp((2.*((V*96485.)/(8314.*310.))))))-(((pow(10.,(((-(1.82e6*(pow((74.*310.),-1.5))))*4.)*(((sqrt(((0.5*(((140.0+5.0)+150.0)+(4.*1.8)))/1000.)))/(1.+(sqrt(((0.5*(((140.0+5.0)+150.0)+(4.*1.8)))/1000.)))))-((0.3*((0.5*(((140.0+5.0)+150.0)+(4.*1.8)))/1000.)))))))*1.8))))/((torch.expm1((2.*((V*96485.)/(8314.*310.))))))))*self.d)*((((0.52477*self.ff)+((1.-(0.52477))*self.fs))*(1.0-(self.nca)))+((self.jca*(((0.3+(0.6/(1.+(torch.exp(((V-(9.24247))/27.96201))))))*self.fcaf)+((1.-((0.3+(0.6/(1.+(torch.exp(((V-(9.24247))/27.96201))))))))*self.fcas)))*self.nca))))+(self.camk_f_ICaL*((((1.1*((1.5768e-04)))*(((4.*(((V*96485.)*96485.)/(8314.*310.)))*((((torch.pow(10.,(((-(1.82e6*(pow((74.*310.),-1.5))))*4.)*(((torch.sqrt(((0.5*(((self.nasl+self.Ki)+self.Cli)+(4.*self.casl)))/1000.)))/(1.+(torch.sqrt(((0.5*(((self.nasl+self.Ki)+self.Cli)+(4.*self.casl)))/1000.)))))-((0.3*((0.5*(((self.nasl+self.Ki)+self.Cli)+(4.*self.casl)))/1000.)))))))*self.casl)*(torch.exp((2.*((V*96485.)/(8314.*310.))))))-(((pow(10.,(((-(1.82e6*(pow((74.*310.),-1.5))))*4.)*(((sqrt(((0.5*(((140.0+5.0)+150.0)+(4.*1.8)))/1000.)))/(1.+(sqrt(((0.5*(((140.0+5.0)+150.0)+(4.*1.8)))/1000.)))))-((0.3*((0.5*(((140.0+5.0)+150.0)+(4.*1.8)))/1000.)))))))*1.8))))/((torch.expm1((2.*((V*96485.)/(8314.*310.))))))))*self.d)*((((0.52477*self.ffp)+((1.-(0.52477))*self.fs))*(1.0-(self.nca)))+((self.jca*(((0.3+(0.6/(1.+(torch.exp(((V-(9.24247))/27.96201))))))*self.fcafp)+((1.-((0.3+(0.6/(1.+(torch.exp(((V-(9.24247))/27.96201))))))))*self.fcas)))*self.nca)))))*self.ical_pureCDI_junc)*0.8)))/0.45),4.5))))))/1.e-3)))/64.11202)
        set_jrel_icaldep_f2_tozero_in_diff_jrel_icaldep_f2 = ((1./(1.+((1.-((1./(1.+(torch.pow(((torch.abs((((((1.-(self.camk_f_ICaL))*(((((1.5768e-04))*(((4.*(((V*96485.)*96485.)/(8314.*310.)))*((((torch.pow(10.,(((-(1.82e6*(pow((74.*310.),-1.5))))*4.)*(((torch.sqrt(((0.5*(((self.nasl+self.Ki)+self.Cli)+(4.*self.casl)))/1000.)))/(1.+(torch.sqrt(((0.5*(((self.nasl+self.Ki)+self.Cli)+(4.*self.casl)))/1000.)))))-((0.3*((0.5*(((self.nasl+self.Ki)+self.Cli)+(4.*self.casl)))/1000.)))))))*self.casl)*(torch.exp((2.*((V*96485.)/(8314.*310.))))))-(((pow(10.,(((-(1.82e6*(pow((74.*310.),-1.5))))*4.)*(((sqrt(((0.5*(((140.0+5.0)+150.0)+(4.*1.8)))/1000.)))/(1.+(sqrt(((0.5*(((140.0+5.0)+150.0)+(4.*1.8)))/1000.)))))-((0.3*((0.5*(((140.0+5.0)+150.0)+(4.*1.8)))/1000.)))))))*1.8))))/((torch.expm1((2.*((V*96485.)/(8314.*310.))))))))*self.d)*((((0.52477*self.ff)+((1.-(0.52477))*self.fs))*(1.0-(self.nca)))+((self.jca*(((0.3+(0.6/(1.+(torch.exp(((V-(9.24247))/27.96201))))))*self.fcaf)+((1.-((0.3+(0.6/(1.+(torch.exp(((V-(9.24247))/27.96201))))))))*self.fcas)))*self.nca))))+(self.camk_f_ICaL*((((1.1*((1.5768e-04)))*(((4.*(((V*96485.)*96485.)/(8314.*310.)))*((((torch.pow(10.,(((-(1.82e6*(pow((74.*310.),-1.5))))*4.)*(((torch.sqrt(((0.5*(((self.nasl+self.Ki)+self.Cli)+(4.*self.casl)))/1000.)))/(1.+(torch.sqrt(((0.5*(((self.nasl+self.Ki)+self.Cli)+(4.*self.casl)))/1000.)))))-((0.3*((0.5*(((self.nasl+self.Ki)+self.Cli)+(4.*self.casl)))/1000.)))))))*self.casl)*(torch.exp((2.*((V*96485.)/(8314.*310.))))))-(((pow(10.,(((-(1.82e6*(pow((74.*310.),-1.5))))*4.)*(((sqrt(((0.5*(((140.0+5.0)+150.0)+(4.*1.8)))/1000.)))/(1.+(sqrt(((0.5*(((140.0+5.0)+150.0)+(4.*1.8)))/1000.)))))-((0.3*((0.5*(((140.0+5.0)+150.0)+(4.*1.8)))/1000.)))))))*1.8))))/((torch.expm1((2.*((V*96485.)/(8314.*310.))))))))*self.d)*((((0.52477*self.ffp)+((1.-(0.52477))*self.fs))*(1.0-(self.nca)))+((self.jca*(((0.3+(0.6/(1.+(torch.exp(((V-(9.24247))/27.96201))))))*self.fcafp)+((1.-((0.3+(0.6/(1.+(torch.exp(((V-(9.24247))/27.96201))))))))*self.fcas)))*self.nca)))))*self.ical_pureCDI_junc)*0.8)))/0.45),4.5))))))/6.e-4)))/119.48978)
